<template>
  <div
    ...
    class="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 transition-colors duration-300"
    :style="{
  ...
  >
    ...
    <h2
      class="text-2xl sm:text-3xl font-bold text-center mb-4 sm:mb-6 font-clash mt-16 sm:mt-0 transition-colors"
      :class="isDark ? 'text-white' : 'text-[#111111]'"
    >
      Добро пожаловать
    </h2>
    ...
    <div
      class="w-full max-w-md p-4 sm:p-8 rounded-lg shadow-lg transition-all duration-300"
      :class="
        isDark
    ...
    >
      <form @submit.prevent="handleSubmit">
        ...
        <button
          type="submit"
          class="w-full bg-[#6C5BD4] text-white py-2.5 sm:py-3 rounded-lg transition-all my-3 sm:my-4 sm:mt-5 font-clash text-sm sm:text-base hover:bg-[#5a4bc4] active:scale-[0.98]"
        >
          Register
        </button>
      </form>
